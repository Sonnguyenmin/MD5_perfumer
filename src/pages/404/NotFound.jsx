    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-[400px] w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl">
        <div className="text-center">
          <h1 className="text-6xl font-extrabold text-gray-900 mb-2 animate-bounce">404</h1>
          <p className="text-3xl font-bold text-gray-900 mb-4">Ối! Không tìm thấy trang</p>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            <p className="text-[15px] text-gray-500 mb-2 ">Hoặc thử những liên kết các trang này:</p>
